...
export function DepositModal({ detail, handler, openState }) {
  ...
  return (
    <>
      <Dialog size='xs' open={openState} handler={handler} className='bg-transparent shadow-none'>
        <Card
          variant='gradient'
          color='gray'
          ...
          <CardFooter className='pt-0 flex flex-row'>
            <button
              ...
              disabled={!file || isUploading || amount === "" || amount <= 0}>
